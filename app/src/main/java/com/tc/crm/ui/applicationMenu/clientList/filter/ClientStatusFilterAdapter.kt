...
class ClientStatusFilterAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    lateinit var mContext: Activity
    private var mList: List<ClientStatusFilterItem>? = null


    fun setData(activity: Activity, data: List<ClientStatusFilterItem>?) {
        mList = data
        mContext = activity
