...
class ClientStageFilterAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    lateinit var mContext: Activity
    private var mList: List<ClientStageFilterItem>? = null


    fun setData(activity: Activity, data: List<ClientStageFilterItem>?) {
        mList = data
        mContext = activity
