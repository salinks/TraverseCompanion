...
public class JDSpinner extends AppCompatTextView {
    ...
    private JDSpinnerBaseAdapter adapter;
    ...
    public JDSpinner(Context context) {
        super(context);
        init(context, null);
    }

    public JDSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public JDSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.JDSpinner);
        ...
        setPadding(resources.getDimensionPixelSize(R.dimen.three_grid_unit), defaultPadding, defaultPadding,
                defaultPadding);
        setClickable(true);
        backgroundSelector = typedArray.getResourceId(R.styleable.JDSpinner_backgroundSelector, R.drawable.selector);
        setBackgroundResource(backgroundSelector);
        textColor = typedArray.getColor(R.styleable.JDSpinner_textTint, getDefaultTextColor(context));
        ...
        popupWindow.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (onSpinnerItemSelectedListener != null) {
                    onSpinnerItemSelectedListener.onItemSelected(JDSpinner.this, view, position, id);
                }
        ...
        isArrowHidden = typedArray.getBoolean(R.styleable.JDSpinner_hideArrow, false);
        arrowDrawableTint = typedArray.getColor(R.styleable.JDSpinner_arrowTint, getResources().getColor(android.R.color.black));
        arrowDrawableResId = typedArray.getResourceId(R.styleable.JDSpinner_arrowDrawable, R.drawable.arrow);
        dropDownListPaddingBottom =
                typedArray.getDimensionPixelSize(R.styleable.JDSpinner_dropDownListPaddingBottom, 0);
        horizontalAlignment = PopUpTextAlignment.fromId(
                typedArray.getInt(R.styleable.JDSpinner_popupTextAlignment, PopUpTextAlignment.CENTER.ordinal())
        );

        CharSequence[] entries = typedArray.getTextArray(R.styleable.JDSpinner_entries);
        if (entries != null) {
    ...
    public <T> void attachDataSource(@NonNull List<T> list) {
        adapter = new JDSpinnerAdapter<>(getContext(), list, textColor, backgroundSelector, spinnerTextFormatter, horizontalAlignment);
        setAdapterInternal(adapter);
    }

    public void setAdapter(ListAdapter adapter) {
        this.adapter = new JDSpinnerAdapterWrapper(getContext(), adapter, textColor, backgroundSelector,
    ...
    private <T> void setAdapterInternal(JDSpinnerBaseAdapter<T> adapter) {
